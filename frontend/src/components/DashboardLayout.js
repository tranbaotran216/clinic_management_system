...
const rawMenuConfig = [
  ...
  { key: 'accounts', labelText: 'Quản lý tài khoản', path: 'accounts', icon: <UserOutlined />, permission: 'auth.view_user' },
  { key: 'appointments', labelText: 'Quản lý khám bệnh', path: 'appointments', icon: <TeamOutlined />, permission: 'patients.manage_patient_waiting_list' },
  { key: 'medical-records', labelText: 'Quản lý phiếu khám', path: 'medical-records', icon: <BookOutlined />, permission: 'medrecords.manage_medical_records' },
  {
    key: 'medications',
    labelText: 'Quản lý Thuốc',
    icon: <MedicineBoxOutlined />,
    children: [
      { key: 'medications-inventory', labelText: 'QL Kho Thuốc', path: 'medications/inventory', icon: <MedicineBoxOutlined />, permission: 'medications.manage_inventory' },
      { key: 'medications-usage', labelText: 'Kê sử dụng thuốc', path: 'medications/usage', icon: <ExperimentOutlined />, permission: 'medications.view_usage_reports' },
      { key: 'medications-search', labelText: 'Tra cứu thuốc', path: 'medications/search', icon: <SearchOutlined />, permission: 'medications.search_inventory' },
    ]
  },
  { key: 'billing', labelText: 'Xem hóa đơn', path: 'billing', icon: <FileTextOutlined />, permission: 'billing.view_invoices' },
  { key: 'reports', labelText: 'Báo cáo & Thống kê', path: 'reports', icon: <BarChartOutlined />, permission: 'reports.view_revenue_statistics' },
  { key: 'regulations', labelText: 'Quản lý quy định', path: 'regulations', icon: <SettingOutlined />, permission: 'clinic.manage_regulations' },
];
